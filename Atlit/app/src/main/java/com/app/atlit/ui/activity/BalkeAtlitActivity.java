...
public class BalkeAtlitActivity extends AppCompatActivity {
            ...
            if (btnSimpan.getText().equals("Kembali")) {
                ...
                if (isProcess) {
                    if (TextUtils.isEmpty(edtnama.getText())) {
                        ...
                        Call<com.app.atlit.model.pojo.retrofit.BalkeRetrofit> balkePost = mApiInterface.balkePost(
                        ...
                        balkePost.enqueue(new Callback<com.app.atlit.model.pojo.retrofit.BalkeRetrofit>() {
                            @Override
                            public void onResponse(Call<com.app.atlit.model.pojo.retrofit.BalkeRetrofit> call, Response<com.app.atlit.model.pojo.retrofit.BalkeRetrofit> response) {
                            ...
                            @Override
                            public void onFailure(Call<com.app.atlit.model.pojo.retrofit.BalkeRetrofit> call, Throwable t) {
    ...
    private void fillData() {
        hideProgress(1);
        Call<com.app.atlit.model.pojo.retrofit.AtlitRetrofit> getData = mApiInterface.atlitGets(loginsharedpreference.getUserLogin().getId());
