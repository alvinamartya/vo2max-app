...
public class CooperGetPojo implements Parcelable {
    private int id;
    private String nama;
    ...
    public CooperGetPojo(int id, String nama, float vo2max, String tingkat_kebugaran, int bulan, int minggu, int waktu) {
        this.id = id;
        this.nama = nama;
        this.vo2max = vo2max;
    ...
    protected CooperGetPojo(Parcel in) {
        id = in.readInt();
        nama = in.readString();
        vo2max = in.readFloat();
    ...
    public static final Creator<CooperGetPojo> CREATOR = new Creator<CooperGetPojo>() {
        @Override
        public CooperGetPojo createFromParcel(Parcel in) {
            return new CooperGetPojo(in);
        }

        @Override
        public CooperGetPojo[] newArray(int size) {
            return new CooperGetPojo[size];
        }
    };
