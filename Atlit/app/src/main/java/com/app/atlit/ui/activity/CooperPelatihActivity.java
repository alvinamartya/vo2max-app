...
import com.app.atlit.ui.adapter.CooperListAdapter;
...
public class CooperPelatihActivity extends AppCompatActivity {
    ...
    public void load() {
        mApiInterface.getListDataCooper(loginsharedpreference.getUserLogin().getCabor()).enqueue(new Callback<List<CooperGetPojo>>() {
            @Override
            public void onResponse(Call<List<CooperGetPojo>> call, Response<List<CooperGetPojo>> response) {
            ...
            @Override
            public void onFailure(Call<List<CooperGetPojo>> call, Throwable t) {
                hideProgress(2);
