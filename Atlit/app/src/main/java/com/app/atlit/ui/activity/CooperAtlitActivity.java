            ...
            if (btnSimpan.getText().equals("Kembali")) {
                ...
                if (isProcess) {
                    if (TextUtils.isEmpty(edtnama.getText())) {
                        ...
                        Call<com.app.atlit.model.pojo.retrofit.CooperRetrofit> cooper = mApiInterface.cooperPost(
                        ...
                        cooper.enqueue(new Callback<com.app.atlit.model.pojo.retrofit.CooperRetrofit>() {
                            @Override
                            public void onResponse(Call<com.app.atlit.model.pojo.retrofit.CooperRetrofit> call, Response<com.app.atlit.model.pojo.retrofit.CooperRetrofit> response) {
                            ...
                            @Override
                            public void onFailure(Call<com.app.atlit.model.pojo.retrofit.CooperRetrofit> call, Throwable t) {
