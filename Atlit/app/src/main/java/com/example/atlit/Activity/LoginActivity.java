    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(v -> {
            if (TextUtils.isEmpty(txtUsername.getText().toString())) {
                ...
                final Call<loginModel> login = apiInterface.login(
                        ...
                        if (response.isSuccessful()) {
                            if (response.body().getMessage().equals("anda berhasil login")) {
                                ...
                                if (response.body().getData().getAkses().equals("atlit")) {
                                    Call<atlitModel> getSingleDataAtlit = apiInterface.atlitGets(response.body().getData().getId());
                                    getSingleDataAtlit.enqueue(new Callback<atlitModel>() {
                                        @Override
