...
public class Atlit implements Parcelable {
    private int ID;
    private int refid;
    private String nama;
    ...
    public Atlit(int ID, int refid, String nama, String tanggal_lahir, float tinggi_badan, float berat_badan, String jenis_kelamin, int atlit, String cabang_olahraga) {
        this.ID = ID;
        this.refid = refid;
        this.nama = nama;
    ...
    public static final Creator<Atlit> CREATOR = new Creator<Atlit>() {
        @Override
        public Atlit createFromParcel(Parcel in) {
            return new Atlit(in);
        }

        @Override
        public Atlit[] newArray(int size) {
            return new Atlit[size];
        }
    };
