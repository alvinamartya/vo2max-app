...
public class BeepGet implements Parcelable {
    private int id;
    private String nama;
    ...
    public static final Creator<BeepGet> CREATOR = new Creator<BeepGet>() {
        @Override
        public BeepGet createFromParcel(Parcel in) {
            return new BeepGet(in);
        }

        @Override
        public BeepGet[] newArray(int size) {
            return new BeepGet[size];
        }
    };
