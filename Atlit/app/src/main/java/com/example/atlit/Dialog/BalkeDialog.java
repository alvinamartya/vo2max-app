...
import com.example.atlit.Activity.LoginActivity;
...
public class BalkeDialog extends DialogFragment {
    ...
    private BalkeGet balkeGet;
    private ApiInterface mApiInterface;
    private Context context;

    public BalkeDialog(BalkeGet balkeGet, Context context) {
        this.balkeGet = balkeGet;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvNama.setText(balkeGet.getNama());
        tvJarak.setText(String.valueOf(balkeGet.getJarak_ditempuh()));
        tvVo2max.setText(String.valueOf(balkeGet.getVo2max()));
        tvTingkatKebugaran.setText(balkeGet.getTingkat_kebugaran());
        tvBulan.setText(String.valueOf(balkeGet.getBulan()));
        tvMinggu.setText(String.valueOf(balkeGet.getMinggu()));
        ...
        btnSimpan.setOnClickListener(view -> {
            if(edtSolusi.getText().toString().isEmpty()) {
                ...
                mApiInterface.setSolusiBalke(balkeGet.getId(), edtSolusi.getText().toString()).enqueue(new Callback<Process>() {
                    @Override
