        ...
        btnSimpan.setOnClickListener(view -> {
            ...
            if(TextUtils.isEmpty(edtMinggu.getText())) {
                ...
                if(isProcess) {
                    ...
                    Call<beepModel> beepModel = apiInterface.beepPost(
                    ...
                    beepModel.enqueue(new Callback<com.example.atlit.RetrofitModel.beepModel>() {
                        @Override
                        public void onResponse(Call<com.example.atlit.RetrofitModel.beepModel> call, Response<com.example.atlit.RetrofitModel.beepModel> response) {
                        ...
                        @Override
                        public void onFailure(Call<com.example.atlit.RetrofitModel.beepModel> call, Throwable t) {
                    ...
                    if(!loginsharedpreference.getUserLogin().getAkses().equals("atlit")) {
                        Call<beepModel> beepModel2 = apiInterface.beepPost(
                                Integer.parseInt(edtBulan.getText().toString()),
                                Integer.parseInt(edtMinggu.getText().toString()),
                                getIntent().getIntExtra(EXTRA_LEVEL, 0),
                        ...
                        beepModel2.enqueue(new Callback<com.example.atlit.RetrofitModel.beepModel>() {
                            @Override
                            public void onResponse(Call<com.example.atlit.RetrofitModel.beepModel> call, Response<com.example.atlit.RetrofitModel.beepModel> response) {
                                if(response.isSuccessful()) {
                                    if(response.body().getMessage().equals("berhasil menambahkan data")) {
